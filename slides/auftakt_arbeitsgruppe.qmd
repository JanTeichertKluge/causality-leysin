...
- klare kausale Frage
- Kernidee oder Methode
- eine explizite Annahme
- Bezug zu einer Studie, einem Design oder einer Kontroverse
...
- Simulation, Analyse oder Visualisierung
- mindestens ein Regler, Vergleich oder Szenario
- eine sichtbare Annahme oder Grenze
- nachvollziehbar für die anderen Gruppen
...
## Kein Dashboard, sondern eine Erkenntnis
...
## Darstellung der Projekte auf der Website

:::: {.columns}

::: {.column width="48%"}

### Option 1: Projektseite in Markdown

- Ordner aus der Vorlage kopieren
- **projekt.md** mit Titel, Team und Erklärung ausfüllen
- Plots oder Screenshots hinzufügen
- gut für Theorie, Case Study und Dokumentation

:::

::: {.column width="48%"}

### Kür: Interaktive Streamlit-App

- zusätzlich **app.py** im Projektordner
- Slider, Simulationen und eigene Visualisierungen
- nur Pakete aus den vorhandenen Requirements
- wir helfen beim Debugging und bei der Umsetzung
...
## Causal Claims Clinic

1. **Allein · 1 Minute:** Wähle eine Behauptung oder Studienidee.
2. **Zu zweit · 3 Minuten:** Formuliert Treatment, Outcome und einen möglichen Bias.
3. **Zu viert · 4 Minuten:** Skizziert ein Design oder eine Annahme.
4. **Plenum · 3 Minuten:** Eine Gruppe teilt ihre präziseste Frage.

::: {.notes}
47–58 Minuten. Diese Struktur folgt dem Gedanken von 1–2–4–All: Erst selbst denken, dann Vergleichsmöglichkeiten erweitern. Bei knapper Zeit Plenum auf zwei Beiträge begrenzen.
:::
...
- „Mentoring erhöht Studienerfolg.“
- „KI-Feedback verbessert wissenschaftliches Schreiben.“
- „Homeoffice steigert Produktivität.“
- „Screeningprogramme verbessern Gesundheit.“
- „Eine Preiserhöhung senkt Nachfrage.“
- „Explainable AI erhöht Vertrauen in Entscheidungen.“
- „LLMs verbessern kausales Denken.“
...
2. **Einführung in Kausale Inferenz**  
...
- Die AG ist ein Labor: Methodisches Arbeiten, kausale Argumente und Prototypen zählen.
- Kausalität beginnt mit einer präzisen Frage, nicht mit einem Algorithmus.
- Gute Projekte verbinden Methode, Annahmen, Interaktion und Grenzen.
- Im Kern geht es bei kausaler Inferenz um die Frage, was unter einer anderen Entscheidung passiert wäre.

## Bild- und Quellenhinweise

- Schuhe im Bett / Kopfschmerzen: [Brady Neal, *Causal Inference from a Machine Learning Perspective*](https://www.bradyneal.com/causal-inference-course#course-textbook/)
- Weitere Quellen und Einordnungen sind direkt in den jeweiligen Lehrgrafiken angegeben.
- Die Wein-Grafik ist eine eigens für diese Präsentation erzeugte Lehrillustration; sie stellt keine empirische Evidenz dar.
