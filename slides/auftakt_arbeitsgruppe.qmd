...
- Doktorand in Statistik / **Causal Machine Learning**
...
Jeder stellt seinen Sitznachbarn vor!

1. Ihr habt 3 Minuten Zeit euren Sitznachbarn kennenzulernen
2. Wir machen eine Runde - wie viel kannst du uns über deinen Sitznachbarn erzählen?
   - z.B., Name, Studienort, Forschungsinteresse oder Fach, Fun Fact ​​​🙂​


::: {.notes}
10–25 Minuten. Eine sichtbare Uhr hilft. Nach etwa zwölf Minuten aktiv schließen und ankündigen, dass Fachinteressen beim Projektmatching wieder aufgegriffen werden.
:::
...
::: {.fragment}
1. „In meinem Studienfach ist zwischen Korrelation und Kausalitäten unterscheiden sehr wichtig.“ 
::: 
::: {.fragment}
2. „(Trainierte) Modelle mit großen Datenmengen und vielen Parametern liefern automatisch einen guten Output.“
:::
::: {.fragment}
3. „Die Definition von Zielgröße und Annahmen ist bei datengetriebener Forschung wichtiger als die Stichprobengröße“
:::
...
🏥 **Randomisierte Experimente / Medizin**

🔍 **Explainable ML / AI** 

💬 **Causality and LLMs** 

🕸️ **DAGs / Causal Discovery** 
...
|---|---|
| **Frage & Motivation** | eine präzise Forschungsfrage |
...
| **Streamlit & Story** | Samstag morgens | Interaktion, Erklärung, Findings  |
| **Finalisierung** | Samstag vormittags | Prototyp der App |
...
3. **Erste Skizze festhalten:** ✍️
  * Wir möchten verstehen: ...
  * Dafür wäre ein gutes Beispiel / Setup: ...
  * Diese Annahme oder Frage müssten wir klären: ...

::: {.callout-note appearance="simple"}
Wenn ihr schon eine Idee vorbereitet habt, nutzt die Runde zur *Diskussion*: Ist die Frage eng genug? 
:::
...
::: {.column width="24%"}
![](figs/bradyneal.png){fig-alt="Vorschaubild der Videoreihe Introduction to Causal Inference von Brady Neal." height="150"}
:::
...
::: {.column width="24%"}
![](figs/causalbandits.jpg){fig-alt="Cover des Causal Bandits Podcast." height="150"}
:::
...
::: {.column width="24%"}
![](figs/themixtape.png){fig-alt="Cover von Causal Inference: The Mixtape." height="150"}
:::
