...
- Gestern habe wir verschiedene kausale Fragestellungen und Biase **qualitativ** beschrieben
- Heute wollen wir anschauen, wir man unsere Erkenntnisse **quantifiziert**

Dazu sprechen wir über:
 - Potential Outcomes und Counterfactuals
 - Das fundamentale Problem der Kausalen Inferenz sowie das Simpsons Paradoxon
...
| $E[\cdot | \cdot]$ | Bedingter Erwartungswert |
...
:::{.fragment}
**Alle zusammen**: Zusammenhang kann **negativ** sein 
...
## Potentielle Outcomes und Definition kausaler Effekt
...
## Randomisierung: Grenzen
 ...
 - Randomisierung gilt als der *Goldstandard* der kausalen Inferenz
 - So einfach ist es aber nicht:
   - In kleinen Samples kann es zufällige Selektion geben
   - Non-Compliance führt zu Bias

**Häufig ist Randomisierung technisch oder ethisch unmöglich.**

Wenn Random nicht greift, müssen wir schauen, **welche kausale Rolle unsere Variablen spielen?**
...
```{mermaid}
flowchart LR
  D["Werbung D"] --> C["KInteresse (Klick auf Produktseite C)"]
...
3. **Positivität (Overlap):** Für jedes relevante $z$ gibt es beide Treatmentzustände:
 ...
 - Diese Annahmen lassen sich durch Fachwissen, Design und Diagnostik plausibel machen
 - Die Annahmen sind nicht testbar!!
...
4. Kontrollvariablen werden aus dem DAG gewählt. Confounder nützen, Mediator oder Collider schaden potentiell.
